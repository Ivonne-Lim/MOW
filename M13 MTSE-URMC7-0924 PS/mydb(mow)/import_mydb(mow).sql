...
-- Schema mydb(mow)
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `mydb(mow)` ;

-- -----------------------------------------------------
-- Schema mydb(mow)
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `mydb(mow)` DEFAULT CHARACTER SET utf8 ;
USE `mydb(mow)` ;

-- -----------------------------------------------------
-- Table `mydb(mow)`.`Profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb(mow)`.`Profile` ;

CREATE TABLE IF NOT EXISTS `mydb(mow)`.`Profile` (
  ...
  CONSTRAINT `FK_Profile_Provider`
    ...
    REFERENCES `mydb(mow)`.`Profile` (`ID`));


-- -----------------------------------------------------
-- Table `mydb(mow)`.`Caregiver_Member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb(mow)`.`Caregiver_Member` ;

CREATE TABLE IF NOT EXISTS `mydb(mow)`.`Caregiver_Member` (
...
-- Table `mydb(mow)`.`Menu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb(mow)`.`Menu` ;

CREATE TABLE IF NOT EXISTS `mydb(mow)`.`Menu` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- Table `mydb(mow)`.`Meal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb(mow)`.`Meal` ;

CREATE TABLE IF NOT EXISTS `mydb(mow)`.`Meal` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb(mow)`.`Pickup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb(mow)`.`Pickup` ;

CREATE TABLE IF NOT EXISTS `mydb(mow)`.`Pickup` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK_Pickup_Meal`
    FOREIGN KEY (`Meal_ID`)
    REFERENCES `mydb(mow)`.`Meal` (`ID`));


-- -----------------------------------------------------
-- Table `mydb(mow)`.`Feedback`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb(mow)`.`Feedback` ;

CREATE TABLE IF NOT EXISTS `mydb(mow)`.`Feedback` (
  `ID` INT NOT NULL AUTO_INCREMENT,
